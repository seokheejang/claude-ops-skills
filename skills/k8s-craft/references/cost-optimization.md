<!--
Source: github.com/Jeffallan/claude-skills/blob/main/skills/kubernetes-specialist/references/cost-optimization.md
License: MIT (origin: Jeffallan)
Note: 자료성 reference. 실제 적용은 k8s-craft Safety Rules에 따라 사용자 명령으로만.
-->
