<!--
Source: github.com/Jeffallan/claude-skills/blob/main/skills/kubernetes-specialist/references/helm-charts.md
License: MIT (origin: Jeffallan)
Note: helm-ops chart authoring reference. 실제 helm install/upgrade는 K8s READ-ONLY 글로벌 룰에 따라 사용자 명령으로만.
-->
