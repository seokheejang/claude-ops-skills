<!--
Source: github.com/Jeffallan/claude-skills/blob/main/skills/kubernetes-specialist/references/troubleshooting.md
License: MIT (origin: Jeffallan)
Note: k8s-ops 트러블슈팅 reference. READ-ONLY 영역만 사용.
-->
