<!--
Source: github.com/Jeffallan/claude-skills/blob/main/skills/kubernetes-specialist/references/gitops.md
License: MIT (origin: Jeffallan)
Note: argocd-ops GitOps reference. READ-ONLY + 작성 가이드.
-->
