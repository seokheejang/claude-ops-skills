...
|-------|------|-----------|
| GitOps deep dive (ArgoCD/Flux 설치, App, AppSet, sealed secrets, progressive delivery) | [references/gitops.md](references/gitops.md) | 설치 가이드, 대규모 GitOps 패턴, SealedSecrets, ApplicationSet generator 작성 |
